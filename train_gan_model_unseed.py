...
gan_data_dir = "gan/gan_training_data"
...
gan_data_params = pd.read_csv(gan_data_dir + '/data_params.csv')
gan_size = gan_data_params['filterSize'].iloc[0]
gan_depth = gan_data_params['filterDepth'].iloc[0]
gan_train_frac = 0.8
gan_val_frac = 0.1
lambda_gan = 0.1
...
path = "experiments/unseed_gan_experiment_" + timestamp
